...
export const getEmoji = (name) => {
    switch (name) {
        ...
        case "Lithuania":
            return "🇱🇹";
        case "Omniva":
            return <span role="img" aria-label="Omniva">
                    <img src={omniva_logo} width="28" height="28" alt="Omniva"/>
            </span>;
        case "Itella":
            return <span role="img" aria-label="Itella">
                    <img src={itella_logo} width="28" height="28"
                         alt="Itella"/>
            </span>;
        case "DPD":
            return <span role="img" aria-label="DPD">
                     <img src={dbd_logo} width="28" height="28"
                          alt="DPD"/>
            </span>;
        default:
            return ""
