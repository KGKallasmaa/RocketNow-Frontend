...
const script_url = "https://maps.googleapis.com/maps/api/js?key=" + process.env.REACT_APP_GOOGLE_PLACES_API_KEY + "&libraries=places&input=address&inputtype=textquery&callback=handleScriptLoad";
...
export class AddressForm extends React.PureComponent {
    ...
    shouldComponentUpdate(nextProps, nextState, nextContext) {
        if (this.props.ShippingAddressLine1 === nextProps.ShippingAddressLine1){
            console.log("I will not update. Mu ha ha");
            return false;
        }
        return true;
    }
