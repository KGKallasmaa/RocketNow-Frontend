                    ...
                    <div className="row">
                        ...
                        <div className="col-md-10">
                            ...
                            <p>You represent and warrant that:<br/>
                                ...
                                connection with any Purchase;<br/>
                                (ii) the information you supply to us is true, correct and complete.
                            </p>
                            <p>By submitting such information, you grant us the right to provide the information to
                            ...
                            <p>We cannot and do not guarantee the accuracy or completeness of any information,
                            ...
                            <p>Any contests, sweepstakes
                                or other promotions (collectively, "Promotions") made available through the Service may
                                be governed by rules that are separate from these Terms. If you participate in any
                            ...
                            <p>If you do enter your billing information when signing up for the Free Trial, you will
                                not be charged by RocketNow Technologies OÜ until the Free Trial has expired. On the
                                last day of the Free Trial period, unless you cancelled your Subscription, you will
                                be automatically charged the applicable Subscription fees for the type of
                                Subscription you have selected.
                            </p>
                            <p>At any time and without notice, RocketNow Technologies OÜ reserves the right to (i)
                            ...
                            <p>RocketNow Technologies OÜ will provide you with a reasonable prior notice of any
                            ...
                            <p>By posting Content to the Service, you grant us the right and license to use, modify,
                                ...
                                through the Service. You retain any and all of your rights to any Content you
                                submit, post or display on or through the Service and you are responsible for
                                protecting those rights. You agree that this license includes the right for us to
                                make your Content available to other users of the Service, who may also use your
                                Content subject to these Terms.
                            </p>
                            <p>You represent and warrant that: (i) the Content is yours (you own it) or you have the
                            ...
                            <p>The Service and its original content (excluding
                                ...
                                copyright, trademark, and other laws of both the Estonia and foreign countries. Our
                            ...
                            <p>RocketNow Technologies OÜ has no control over, and assumes no responsibility for, the
                                content, privacy policies, or practices of any third party web sites or services.
                                You further acknowledge and agree that RocketNow Technologies OÜ shall not be
                            ...
                            <p>In no event shall RocketNow Technologies
                                ...
                                (iii) any content obtained from the Service;<br/>
                            ...
                            <p>RocketNow Technologies OÜ its subsidiaries, affiliates, and its licensors do not
