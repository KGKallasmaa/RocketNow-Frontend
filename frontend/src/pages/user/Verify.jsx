    ...
    async verifyEmail(token) {
        ...
        axios.post(process.env.REACT_APP_SERVER_URL, {
            ...
            return res.data;
                ...
                const token = resData.data.verifyEmail.token;
                const tokenExpiration = resData.data.verifyEmail.tokenExpiration;
                const userFullName = resData.data.verifyEmail.userFullName;
                const userImage_URL = resData.data.verifyEmail.userImage_URL;
