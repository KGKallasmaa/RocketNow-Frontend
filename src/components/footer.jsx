          ...
          <div className="row">
            <div className="col-sm-6 col-md-3 item">
              ...
              <ul>
                ...
                <li>
                  <a
                    aria-label={'Market RocketNow goods as an affiliate'}
                    href="http://business.rocketnow.eu/affiliate"
                  >
                    Affiliate program
                  </a>
                </li>
            ...
            <div className="col-sm-6 col-md-3 item">
              ...
              <ul>
                <li>
                  <a aria-label={'Read the story of RocketNow'} href="/about">
                    About
                  </a>
                </li>
                <li>
                  <a aria-label={'See the careers that are currently available'} href="/careers">
                    Careers
                  </a>
                </li>
                <li>
                  <a aria-label={'Please contact us for any inquiries'} href="/contact">
                    Contact
                  </a>
                </li>
              </ul>
            ...
            <div className="col-sm-6 col-md-3 item">
              ...
              <ul>
                <li>
                  <a aria-label={'Read the terms of service'} href="/tos">
                    Terms of Service
                  </a>
                </li>
                <li>
                  <a aria-label={'Read the privacy policy'} href="/privacy">
                    Privacy Policy
                  </a>
                </li>
              </ul>
