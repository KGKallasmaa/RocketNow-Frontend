...
export default class ShoppingCart extends React.Component {
  ...
  render() {
    ...
    const jwt_token = isRegularUserLoggedIn()
      ? sessionStorage.getItem('jwtToken')
      : sessionStorage.getItem('temporary_user_id');
            ...
            <div className="row">
              <div className="col-lg-8 order-2 order-lg-1">
                <form className="checkout-form">
                  ...
                  {this.state.shippingOption !== 'Parcel delivery' ? (
                    <p />
                  ) : (
                ...
                {ShippingCity !== undefined || ParcelDeliveryLocationName !== undefined ? (
                  <GoToPayment
                    jwt_token={jwt_token}
                    ShippingName={ShippingName}
                    ShippingAddressLine1={ShippingAddressLine1}
              ...
              <div className="col-lg-4 order-1 order-lg-2">
                <div className="checkout-cart">
                  ...
                  <ul className="product-list">
                    {componentDidMount === false && shoppingcartGoods !== 'noResults' ? (
                      renderLoadingCartCartItem()
                    ) : (
                      <p />
                    )}
                    {shoppingcartGoods !== undefined && shoppingcartGoods !== 'noResults' ? (
                      shoppingcartGoods.map(renderCartItem)
                    ) : (
                      <p />
                    )}
                  </ul>
