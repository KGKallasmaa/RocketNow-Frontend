...
export class AddressForm extends React.PureComponent {
    ...
    if (!isShippingAddressLine2) {
      ...
      if (validity[name]) {
        if (name === 'ShippingName') {
          ...
          fieldValidationErrors[name] = capitalizeFirstLetter(
            validity[name] ? '' : `Shipping names length should be greater than 4`
          );
              ...
              <div className="col-md-6">
                <Form.Item>
                  ...
                  <input
                    ...
                    onChange={this.handleChange}
                  />
                  <div className="invalid-feedback">{this.state.formErrors.ShippingAddressLine1}</div>
                </Form.Item>
              </div>
              <div className="col-md-6">
                <Form.Item>
                  ...
                  <input
                    ...
                    onChange={this.handleChange}
                  />
                  <div className="invalid-feedback">{this.state.formErrors.ShippingAddressLine2}</div>
                </Form.Item>
              </div>
            </div>
          </div>
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <div className="cf-title">Address Delivery</div>
        {this.renderForm()}
      </React.Fragment>
    );
  }
