...
function renderRegularRow(orderGood) {
  ...
  return (
    <tr>
      ...
      <td>
        {currency}
        {formatNr(orderGood.price_per_one_item)}
      </td>
      <td>
        {currency}
        {formatNr(orderGood.price_per_one_item * orderGood.quantity)}
      </td>
    </tr>
  );
}
          ...
          <div className="row">
            ...
            <div className="col-md-10">
              <table className="table">
                ...
                <tbody>{order_items !== undefined ? order_items.map(renderRegularRow) : <p />}</tbody>
              </table>
              <div className="row">
...
export default class OrderReceipt extends React.Component {
  ...
  render() {
    ...
    if (base !== undefined) {
      return <CompletedOrderReceipt order_id={order_id} base={base} />;
    }
    return (
      <div className="container-fluid">
        <Helmet>
