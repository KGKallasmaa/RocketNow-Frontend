  ...
  return (
    <div className="col-sm-6 col-md-5 col-lg-4 item">
      <div className="box" style={{ width: '100%' }}>
        <LazyLoad>
          <img src={good.image} alt={good.title} style={{ maxWidth: '100%', maxHeight: '200px' }} />
        </LazyLoad>
...
function renderOrdergoods(ordergoods) {
  if (ordergoods) {
    return ordergoods.map((good) => {
      return <OrderGoodCard image={good.main_image_cloudinary_secure_url} title={good.title} />;
    });
  }
  return '';
}
        ...
        <div className="features-boxed">
          <div className="container">
            <div className="intro">
              ...
              <br />
              <p className="text-center">We have received your order and deliver it as soon as possible.</p>
              <br />
            </div>
            <div className="row justify-content-center features">{renderOrdergoods(ordergoods)}</div>
          </div>
        </div>
        <br />
        <br />
