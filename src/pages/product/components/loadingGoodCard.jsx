              ...
              <div className="row">
                ...
                <div className="col-lg-6 product-details">
                  ...
                  <div className="quantity">
                    <p>Quantity</p>
                    <div className="pro-qty" aria-label={'Select how many goods you want to add to your cart'}>
                  ...
                  <div className="social-sharing">
                    <a aria-label={'Share on Facebook'} title={'faceBookUrlText'} href="#">
                      <i className="fa fa-facebook" />
                    </a>
                    <a aria-label={'Share on Twitter'} title={'twitterUrlText'} href="#">
