...
function rendeOtherImages(otherImages, title) {
  ...
  return (
    <div className="product-thumbs" style={otherImagesStyle}>
      <div className="product-thumbs-track">{images}</div>
    </div>
  );
}
...
export default React.memo((props) => {
  ...
  const twitterUrl =
    'https://twitter.com/share?url=' + urlToShare + '&amp;text=Check%20it%20@%20RocketNow🚀&amp;hashtags=rocketnow';
      ...
      <div className="page-top-info">
        <div className="container">
          ...
          <div className="site-pagination">
            ...
            /
            <a title={base.general_category.name} href={categoryUrl}>
              {base.general_category.name}
            </a>
          </div>
        </div>
      </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="product-pic-zoom">
                <img className="product-big-img" src={base.main_image_cloudinary_secure_url} alt={base.title} />
              </div>
            ...
            <div className="col-lg-6 product-details">
              ...
              <h4 className="p-stock">
                Sold by:{' '}
                <a href={sellerUrl}>
                  <span>{base.seller.displayname}</span>
                </a>
              </h4>
              <div className="quantity">
                <p>Quantity</p>
                <div className="pro-qty" aria-label={'Seleclt how many goods you want to add to your cart'}>
                  <input aria-label={'Select product quantity'} type="text" value="1" />
                </div>
              </div>
              ...
              <div className="social-sharing">
                <a aria-label={'Share ' + base.title + ' on Facebook'} title={faceBookUrlText} href={facebookUrl}>
                  <i className="fab fa-facebook" />
                </a>
                <a aria-label={'Share ' + base.title + ' on Twitter'} title={twitterUrlText} href={twitterUrl}>
