...
function mapRegularGood(good, nr, parcelDeliveryEstimate, addressDeliveryEstimate) {
  return (
    <Suspense fallback={'Loading ...'}>
      <RegularGoodCard
        parcelDeliveryEstimate={parcelDeliveryEstimate}
        addressDeliveryEstimate={addressDeliveryEstimate}
        good={good}
        nr={nr}
      />
    </Suspense>
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <br />
        <br />
        {good !== undefined && parcelDeliveryEstimate !== undefined && addressDeliveryEstimate !== undefined ? (
          mapRegularGood(good, this.props.match.params.nr, parcelDeliveryEstimate, addressDeliveryEstimate)
        ) : (
          <p />
        )}
