      ...
      <div className="product-item">
        <div className="pi-pic">
          <a title={good.title} href={good_url}>
            <LazyLoad>
              <img alt={good.title} src={good.imgage} />
            </LazyLoad>
          </a>
    ...
    return (
      <div className="filter-widget">
        ...
        <ul className="sub-menu">
          <RefinementList attribute={refinement} />
        </ul>
      </div>
    );
  }
...
const Hits = ({ hits }) => (
  <div className="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
    <div className="row">{hits.map((hit) => renderSearchResults(hit))}</div>
  </div>
);
      ...
      <React.Fragment>
        ...
        <InstantSearch indexName="product" searchClient={searchClient}>
          ...
          <Button
            shape="circle"
            icon="filter"
            style={{ marginLeft: '10%', color: '#1F96FE' }}
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-3 order-1 order-lg-1" hidden={!filtersAreVisible}>
                ...
                <hr />
                {nonNumericRefinements !== undefined ? (
                  nonNumericRefinements.map(renderNonQuantiativeRefinement)
                ) : (
                  <p />
                )}
                <hr />
                {numericRefinements !== undefined ? numericRefinements.map(renderQuantiativeRefinement) : <p />}
              </div>
              <br />
              <br />
              <CustomHits />
