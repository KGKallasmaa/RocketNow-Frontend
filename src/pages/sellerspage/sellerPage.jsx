...
function renderBusinessUserGoods(good) {
  ...
  return (
    <div className="col-sm-4 flex-box flex-justify-center flex-align-center">
      <a className="fancybox" rel="gallery1" title={good.title} href={url}>
    ...
    return (
      <React.Fragment>
        ...
        <Empty
          ...
          description={<span>{name} hasn't listed any goods yet.</span>}
        >
      ...
      <React.Fragment>
        ...
        <div style={{ backgroundColor: '#f7f7f7' }}>
          <div className="container">
            <br />
            <h1>Products</h1>
            <div className="row flex-box flex-wrap-wrap">{renderGoods(goods)}</div>
