    ...
    return (
      <React.Fragment>
        <Helmet>
          ...
          <meta name="description" content="Please get in touch and let's start something wonderful together." />
            ...
            <div className="row">
              <div className="col-md-6">
                <form onSubmit={this.sendEmail}>
                  <h1 className="text-center" style={{ contactUsHeader }}>
                    Send us a message
                  </h1>
                  ...
                  <div className="form-group">
                    <button className="btn btn-primary btn-block" type="submit" style={{ sendButton }}>
                      Send
                    </button>
                  </div>
                </form>
