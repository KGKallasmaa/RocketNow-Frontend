  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <link rel="canonial" href="http://rocketnow.eu/tos" />
        <meta
          name="description"
          content="These General Terms and Conditions set out the terms and conditions applying to and governing the usage of the RocketNow platform - technology which connects merchants with customers around the world."
        />
      </Helmet>
      <Navbar />
      <header className="masthead text-center text-white">
        <div className="masthead-content">
          <div className="container text-left">
            <h1 className="text-left masthead-heading mb-0" style={font}>
              Terms of Service
            </h1>
        ...
        <div className="row">
          ...
          <div className="col-md-10">
            ...
            <p>
              ...
              https://rocketnow.eu website (the "Service") operated by RocketNow Technologies OÜ ("us", "we","RocketNo"
              or "our").
            </p>
            ...
            <p>
              ...
              <br />
              (i) you have the legal right to use any credit card(s) or other payment method(s) in connection with any
              Purchase;
              <br />
            ...
            <p>
              ...
              conditions unless you cancel it or RocketNow cancels it. You may cancel your Subscription renewal either
              through your online account management page or by contacting RocketNows customer support team.
            </p>
            <p>
              A valid payment method, including credit card, is required to process the payment for your Subscription.
              You shall provide RocketNow with accurate and complete billing information including full name, address,
              state, zip code, telephone number, and a valid payment method information. By submitting such payment
              information, you automatically authorize RocketNow Technologies OÜ to charge all Subscription fees
              incurred through your account to any such payment instruments.
            </p>
            <p>
              Should automatic billing fail to occur for any reason, RocketNow will issue an electronic invoice
              indicating that you must proceed manually, within a certain deadline date, with the full payment
              corresponding to the billing period as indicated on the invoice.
            </p>
            <h3>4. Free&nbsp;Trial</h3>
            <p>
              RocketNow may, at its sole discretion, offer a Subscription with a free trial for a limited period of time
              ("Free Trial").
            </p>
            ...
            <p>
              ...
              RocketNow Technologies OÜ until the Free Trial has expired. On the last day of the Free Trial period,
            ...
            <p>
              At any time and without notice, RocketNow Technologies OÜ reserves the right to (i) modify the terms and
              conditions of the Free Trial offer, or (ii) cancel such Free Trial offer.
            </p>
            <h3>5. Fee&nbsp;Changes</h3>
            <p>
              RocketNow Technologies OÜ, in its sole discretion and at any time, may modify the Subscription fees for
              the Subscriptions. Any Subscription fee change will become effective at the end of the then-current
              Billing Cycle.
            </p>
            <p>
              RocketNow Technologies OÜ will provide you with a reasonable prior notice of any change in Subscription
            ...
            <h3>6. Refunds</h3>
            <p>
              Certain refund requests for Subscriptions may be considered by RocketNow Technologies OÜ on a case-by-case
              basis and granted in sole discretion of RocketNow Technologies OÜ.
            </p>
            <h3>7. Content</h3>
            <p>
            ...
            <p>
              ...
              and will remain the exclusive property of RocketNow Technologies OÜ and its licensors. The Service is
              protected by copyright, trademark, and other laws of both the Estonia and foreign countries. Our
              trademarks and trade dress may not be used in connection with any product or service without the prior
              written consent of RocketNow Technologies OÜ.
            </p>
            ...
            <p>
              RocketNow Technologies OÜ has no control over, and assumes no responsibility for, the content, privacy
              policies, or practices of any third party web sites or services. You further acknowledge and agree that
              RocketNow Technologies OÜ shall not be responsible or liable, directly or indirectly, for any damage or
            ...
            <p>
              In no event shall RocketNow Technologies OÜ, nor its directors, employees, partners, agents, suppliers, or
            ...
            <p>
              RocketNow Technologies OÜ its subsidiaries, affiliates, and its licensors do not warrant that a) the
            ...
            <p>
              These Terms shall be governed and construed in accordance with the laws of Estonia, without regard to its
