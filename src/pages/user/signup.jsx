    ...
    if (validity[name]) {
      switch (name) {
        ...
        case 'email': {
          ...
          fieldValidationErrors[name] = capitalizeFirstLetter(
            validity[name] ? '' : `Please enter a valid email address.`
          );
          break;
        }
        case 'password': {
          ...
          if (!validity[name]) {
            ...
            fieldValidationErrors[name] = capitalizeFirstLetter(
              !validity[name] ? 'Your password should not contain your name or email.' : ``
            );
          } else if (!validity[name]) {
    ...
    return (
      <div className="d-flex flex-column justify-content-center" id="login-box">
        <Helmet>
          ...
          <meta property="og:description" content="Signing up to RocketNow unlocks a whole new world" />
        ...
        <div className="email-login" style={{ backgroundColor: '#ffffff' }}>
          <Form onSubmit={this.PersonalSignupSubmit} className="login-form">
            ...
            <Form.Item>
              <p>
                By signing up I agree to <a href="/tos">Terms of Service</a> and <a href="privacy">Privacy Policy</a>
              </p>
            </Form.Item>
            <Form.Item>
              <button
