...
export default class Verify extends React.Component {
  ...
  rendeText() {
    if (sessionStorage.getItem('jwtToken')) {
      ...
      return (
        <div>
          <h1 className="text-center" style={{ fontSize: '25px', color: '#1F96FE' }}>
  ...
  renderButton() {
    ...
    const twitterUrl =
      'https://twitter.com/share?url=' + urlToShare + '&amp;text=Just%20joined%20RocketNow🚀&amp;hashtags=rocketnow';
    const emailUrl =
      'mailto:?Subject=Join RocketNow🚀 &amp;Body=I%20just%20joined%20RocketNow%20and%20I%20thought%20you%20should%20too!%20' +
      urlToShare;
          ...
          <ul className="list-inline text-center">
            ...
            <li className="list-inline-item">
              <a href={emailUrl} target="_blank">
                <span className="fa-stack fa-lg">
                  <i className="fa fa-circle fa-stack-2x" />
                  <i className="fa fa-share-alt fa-stack-1x fa-inverse" />
                </span>
              </a>
            </li>
          </ul>
          ...
          <form method="post" style={{ width: '450px', padding: '35px' }}>
            ...
            <div className="form-group">
              <div className="container">
                <div className="form-row">{button}</div>
              </div>
            </div>
          </form>
        </div>
